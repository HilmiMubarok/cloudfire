    ...
    <div className="transition-all">
      ...
      <main className="min-h-screen bg-[#000D2F] w-full text-white">
        ...
        <div className="block lg:hidden container mx-auto">
          <nav className="w-full h-[100px] flex items-center justify-between pr-4">
            ...
            <h1 className="font-bold text-2xl text-[#FDC500]">
              CLOUDFIRE ESPORT
            </h1>
            <div>
              {/* hamburger menu with tailwind */}
              <div className="relative inline-block">
                <button
                  className="inline-block text-[#FDC500] focus:outline-none h-16 w-12 rounded-full"
                  aria-label="Menu"
                  aria-haspopup="true"
                >
                  <svg
        ...
        {/* HERO SECTION */}
        <div className="mt-10 lg:mt-[70px] w-full">
